...
export const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    reviewTitlePlaceholder: "مثال: منتج ممتاز جداً",
    comment: "التعليق",
    commentPlaceholder: "شارك تجربتك مع هذا المنتج...",
    selectRating: "من فضلك اختر تقييم",
    enterComment: "من فضلك اكتب تعليق",
  ...
  en: {
    ...
    reviewTitlePlaceholder: "Example: Excellent product",
    comment: "Comment",
    commentPlaceholder: "Share your experience with this product...",
    selectRating: "Please select a rating",
    enterComment: "Please write a comment",
