...
export default function Shop() {
  ...
  const [filter, setFilter] = useState("all"); // all, men, kids
  ...
  useEffect(() => {
    async function fetchProducts() {
      ...
      try {
        ...
        // تطبيق الفلتر لو مختار قسم معين
        if (filter !== 'all') {
    ...
    fetchProducts();
  }, [filter]); // يعيد التحميل لما تغير الفلتر

  // فلترة البحث بالاسم (Client-side search)
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center mt-3">
                    ...
                    <Button 
                      size="icon" 
                      className="h-9 w-9 rounded-full bg-slate-900 hover:bg-blue-600 text-white shadow-lg"
                      onClick={(e) => {
                         e.stopPropagation(); // عشان ميفعلوش اللينك بتاع الصفحة
